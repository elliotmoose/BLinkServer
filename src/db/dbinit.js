...
class DBInit {
    ...
    async initUsers() {
        ...
        let users_list = [{
            ...
            bio : `Hello! My name is Sean. I have Designed multiples posters and videos despite no prior training in Adobe applications. Was a key member in
SUTD Bands publicity pushes which includes SUTD’s own “Intervarsity Jam 2019” and “Rockafall 2019” Publicity
was seen as a success due to the large turnouts and club-profits raised for the aforementioned events.`,
            position : 'CEO',
            ...
            bio : `Hello! My name is Elliot. I love to code and I love to build apps. I think I'm a fun guy but really I'm just a nerd who loves software development. Hey, no shame in the game am I right? 
            Anyhoo, I see you've connected with me. Feel free to contact me thorugh any of the available platforms listed below! I'm particularly active on Linkedin where I'm recieving more than 100 job offers in a day!
            Nonetheless, I've always wanted to be part of a start-up, hence, do feel free to message me if you have an idea that you're willing to share. XOXO`,
